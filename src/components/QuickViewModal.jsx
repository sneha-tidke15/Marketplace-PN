      ...
      {product && (
        <motion.div className="fixed inset-0 z-50 grid place-items-center bg-ink/35 p-4 backdrop-blur-sm" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
          ...
          >
            ...
            <div className="p-6">
              <button onClick={onClose} className="float-right grid h-10 w-10 place-items-center rounded-full bg-white/70 text-ink dark:bg-white/10 dark:text-white">
                <FiX />
              </button>
              ...
              <p className="mt-4 text-sm leading-6 text-slate-600 dark:text-slate-200">{product.description}</p>
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                <button
                  ...
                  className="pill-button bg-ink text-white dark:bg-pastelPink dark:text-ink"
                >
                  Add to cart
                </button>
