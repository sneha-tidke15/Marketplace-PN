    ...
    <section className="pastel-gradient relative overflow-hidden pb-20 pt-10">
      <div className="container-soft grid items-center gap-12 py-12 lg:grid-cols-[1.05fr_0.95fr]">
        ...
        <motion.div className="relative min-h-[440px]" initial={{ opacity: 0, scale: 0.92 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.6 }}>
          ...
          <motion.img animate={{ y: [0, 12, 0] }} transition={{ repeat: Infinity, duration: 5.8 }} src="https://images.unsplash.com/photo-1610701596007-11502861dcfa?auto=format&fit=crop&w=700&q=80" alt="Indian handmade clay art" loading="lazy" className="absolute bottom-0 left-0 h-64 w-52 rounded-[28px] object-cover shadow-soft sm:h-80 sm:w-64" />
